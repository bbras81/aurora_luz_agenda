  ...
  return (
    <div className="lg:col-span-2 col-span-4 bg-white">
      ...
      >
        ...
        <button
          type="submit"
          className="text-white bg-primary hover:bg-[var(--accent-primary)] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Pagar
        </button>
      </form>
